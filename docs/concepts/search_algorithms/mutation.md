...
The correspondence between variable types and `Mutation` is determined by [Problem](../problem_and_ranking/problem.md)'s `variables` argument.
...
- [Problem](../problem_and_ranking/problem.md): Defining integer and categorical variables, and their correspondence with mixed-variable Mutations
